        ...
        <div class="container">
            ...
            <div class="row gy-4">
                <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img
                        src="{{ asset('landing-page-asset/img/features-bg.jpg') }}" alt=""></div>
                <div class="col-lg-6">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('landing-page-asset/img/testimonials/testimonials-1.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('landing-page-asset/img/testimonials/testimonials-2.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>Sara Wilsson</h3>
                            <h4>Designer</h4>
                            <div class="stars">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('landing-page-asset/img/testimonials/testimonials-3.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>Jena Karlis</h3>
                            <h4>Store Owner</h4>
                            <div class="stars">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('landing-page-asset/img/testimonials/testimonials-4.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>Matt Brandon</h3>
                            <h4>Freelancer</h4>
                            <div class="stars">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('landing-page-asset/img/testimonials/testimonials-5.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>John Larson</h3>
                            <h4>Entrepreneur</h4>
                            <div class="stars">
